    ...
    public class CustomBuildingRenderer : BuildingRenderer
    {
        ...
        private void DrawHorrorEffects()
        {
            ...
            if (canvas != null)
            {
                ...
                var fogParticlesField = GetType().BaseType.GetField("_fogParticles", 
                    System.Reflection.BindingFlags.NonPublic | 
                    System.Reflection.BindingFlags.Instance);
                
                var fogParticleTypesField = GetType().BaseType.GetField("_fogParticleTypes", 
                    System.Reflection.BindingFlags.NonPublic | 
                    System.Reflection.BindingFlags.Instance);
                
                var fogParticleRotationsField = GetType().BaseType.GetField("_fogParticleRotations", 
                    System.Reflection.BindingFlags.NonPublic | 
                    System.Reflection.BindingFlags.Instance);

                if (fogParticlesField != null && fogParticleTypesField != null && fogParticleRotationsField != null)
                {
                    ...
                    if (fogParticles != null && fogParticleTypes != null && fogParticleRotations != null)
                    {
        ...
        private void DrawPeopleAndAnimations()
        {
            ...
            var peopleField = GetType().BaseType.GetField("_people", 
                System.Reflection.BindingFlags.NonPublic | 
                System.Reflection.BindingFlags.Instance);
            ...
            var rollingHeadField = GetType().BaseType.GetField("_rollingHead", 
                System.Reflection.BindingFlags.NonPublic | 
                System.Reflection.BindingFlags.Instance);
        ...
        {
            var canvasField = GetType().BaseType.GetField("_canvas", 
                System.Reflection.BindingFlags.NonPublic | 
                System.Reflection.BindingFlags.Instance);
